...
return [
    ...
    'attributes'           => [
        ...
        'price'                 => 'السعر',
        'image'                 => 'الصورة',
        'national_number'       => 'الرقم التعريفي',
        'student_info.national_number' => 'الرقم التعريفي',

        'level'                 => 'المراحل الدراسية',
        'type'                  => 'النوع',
        'students'              => 'الطلاب',
        'class_to_study'        => 'الصفوف الدراسية',
        'divisions_to_study'     => 'الشُعب الدراسية',
        'student_ids'            => 'الطلاب',
        'level_id'            => 'المرحلة',
        'class_id'            => 'الصفوف الدراسية',
        'division_id'            => 'الشُعب الدراسية',
        'attachment_file'       => 'الملف المرفق',
        'transaction_number'    => 'رقم التحويل',
        'sun_start'             =>  'بداية دوام الأحد',
        'mon_start'             =>  'بداية دوام الاثنين',
        'tue_start'             =>  'بداية دوام الثلاثاء',
        'wed_start'             =>  'بداية دوام الأربعاء',
        'thu_start'             =>  'بداية دوام الخميس',
        'fri_start'             =>  'بداية دوام الجمعة',
        'sat_start'             =>  'بداية دوام السبت',
        'sun_end'             =>  'نهاية دوام الأحد',
        'mon_end'             =>  'نهاية دوام الاثنين',
        'tue_end'             =>  'نهاية دوام الثلاثاء',
        'wed_end'             =>  'نهاية دوام الأربعاء',
        'thu_end'             =>  'نهاية دوام الخميس',
        'fri_end'             =>  'نهاية دوام الجمعة',
        'sat_end'             =>  'نهاية دوام السبت',
        'end_date'            =>   'تاريخ النهاية',
        'start_date'            =>   'تاريخ البداية',
        'student_info.accounts.*.email'  => 'الايميل في الحسابات',
        'student_info.accounts.*.name'  => 'الامس في الحسابات',
        'student_info.accounts.*.surname'  => 'الكنية في الحسابات',
        'add_account_father' => 'حساب الأب',
        'add_account_mother' => 'حساب الأم',
        'amount' => 'المبلغ'
